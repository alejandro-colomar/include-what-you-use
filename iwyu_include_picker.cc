...
const IncludeMapEntry libstdcpp_include_map[] = {
  ...
  { "<bits/enable_special_members.h>", kPrivate, "<experimental/optional>", kPublic },
  { "<bits/enable_special_members.h>", kPrivate, "<optional>", kPublic },
  { "<bits/enable_special_members.h>", kPrivate, "<variant>", kPublic },
  { "<bits/erase_if.h>", kPrivate, "<experimental/map>", kPublic },
  { "<bits/erase_if.h>", kPrivate, "<experimental/set>", kPublic },
  { "<bits/erase_if.h>", kPrivate, "<experimental/unordered_map>", kPublic },
  { "<bits/erase_if.h>", kPrivate, "<experimental/unordered_set>", kPublic },
  ...
  { "<debug/assertions.h>", kPrivate, "<experimental/memory_resource>", kPublic },
  { "<debug/assertions.h>", kPrivate, "<memory_resource>", kPublic },
  { "<debug/bitset>", kPrivate, "<bitset>", kPublic },
  { "<debug/debug.h>", kPrivate, "<ext/bitmap_allocator.h>", kPublic },
  { "<debug/debug.h>", kPrivate, "<memory>", kPublic },
  { "<debug/debug.h>", kPrivate, "<random>", kPublic },
  { "<debug/debug.h>", kPrivate, "<tr1/memory>", kPublic },
  { "<debug/debug.h>", kPrivate, "<tr1/random>", kPublic },
  { "<debug/debug.h>", kPrivate, "<valarray>", kPublic },
  ...
  { "<experimental/bits/lfts_config.h>", kPrivate, "<experimental/algorithm>", kPublic },
  { "<experimental/bits/lfts_config.h>", kPrivate, "<experimental/any>", kPublic },
  { "<experimental/bits/lfts_config.h>", kPrivate, "<experimental/chrono>", kPublic },
  { "<experimental/bits/lfts_config.h>", kPrivate, "<experimental/functional>", kPublic },
  { "<experimental/bits/lfts_config.h>", kPrivate, "<experimental/optional>", kPublic },
  { "<experimental/bits/lfts_config.h>", kPrivate, "<experimental/propagate_const>", kPublic },
  { "<experimental/bits/lfts_config.h>", kPrivate, "<experimental/random>", kPublic },
  { "<experimental/bits/lfts_config.h>", kPrivate, "<experimental/ratio>", kPublic },
  { "<experimental/bits/lfts_config.h>", kPrivate, "<experimental/string_view>", kPublic },
  { "<experimental/bits/lfts_config.h>", kPrivate, "<experimental/system_error>", kPublic },
  { "<experimental/bits/lfts_config.h>", kPrivate, "<experimental/tuple>", kPublic },
  { "<experimental/bits/lfts_config.h>", kPrivate, "<experimental/type_traits>", kPublic },
  { "<experimental/bits/lfts_config.h>", kPrivate, "<experimental/utility>", kPublic },
  ...
  { "<ext/pb_ds/detail/standard_policies.hpp>", kPrivate, "<ext/pb_ds/assoc_container.hpp>", kPublic },
  { "<ext/pb_ds/detail/standard_policies.hpp>", kPrivate, "<ext/pb_ds/priority_queue.hpp>", kPublic },
  ...
  { "<ext/pb_ds/detail/type_utils.hpp>", kPrivate, "<ext/pb_ds/hash_policy.hpp>", kPublic },
  { "<ext/pb_ds/detail/type_utils.hpp>", kPrivate, "<ext/pb_ds/tag_and_trait.hpp>", kPublic },
  { "<ext/pb_ds/detail/type_utils.hpp>", kPrivate, "<ext/pb_ds/tree_policy.hpp>", kPublic },
  { "<ext/pb_ds/detail/type_utils.hpp>", kPrivate, "<ext/pb_ds/trie_policy.hpp>", kPublic },
